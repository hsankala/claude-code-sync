...
**Don't suggest CLAUDE-WEB-AI.md if:**
...
**Do suggest CLAUDE-WEB-AI.md if:**
...
If CLAUDE-WEB-AI.md would help, flag it clearly:

```
╭─ NOTE ────────────────────────────────────────────────────────╮
│  This prompt would benefit from project context. Consider     │
│  providing your CLAUDE-WEB-AI.md alongside it so the LLM     │
